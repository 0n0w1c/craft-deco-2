if mods["alien-biomes-graphics"] then
    ...
    for _, tree in pairs(trees) do
        if data.raw["tree"][tree] then
            utils.make_it_craftable(tree, "tree", CRAFTDECO2.ITEM_GROUP, "craftable-alien-biomes-trees",
                "a[alien-biomes-" .. tree .. "]")
        end
    end
    ...
    for _, rock in pairs(rocks) do
        if data.raw["simple-entity"][rock.name] then
            utils.make_it_craftable(rock.name, "simple-entity", CRAFTDECO2.ITEM_GROUP, "craftable-alien-biomes-rocks",
    ...
    local landscaping_effects = data.raw["technology"]["craft-deco-2-landscaping"].effects
